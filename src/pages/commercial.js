...
const Commercial = ({ data }) => {
  return (
    <Layout page="Commercial" headerTitle="Commercial">
      ...
      <LayoutContainer>
        ...
        <ImageCopySection>
          <StyledArticle pos="left">
            <h1>High End Commercial Contractors</h1>
            Apollo Commercial are high end residential contractors in London and
            nationwide. With a seamless design and build ethic, based on
          ...
          <ImageContainer>
            <Img
              sizes={data.commercialImages.edges[5].node.childImageSharp.sizes}
              fadeIn
              style={{ width: '100%' }}
            />
          </ImageContainer>
        ...
        <ImageCopySection>
          <ImageContainer pos="left">
            <Img
              sizes={data.commercialImages.edges[6].node.childImageSharp.sizes}
              fadeIn
              style={{ width: '100%' }}
            />
          </ImageContainer>
        ...
        <ImageCopySection>
          ...
          <ImageContainer>
            <Img
              sizes={data.commercialImages.edges[7].node.childImageSharp.sizes}
              fadeIn
              style={{ width: '100%' }}
            />
          </ImageContainer>
            ...
            <Link to="/case-study/healthcare/residential/#">
              <figure className="effect-sarah">
                <div className="image">
                  <Img
                    sizes={
                      data.commercialImages.edges[3].node.childImageSharp.sizes
                    }
                    fadeIn
                    style={{ width: '100%' }}
                  />
